...
/*
TENSOR3::TENSOR3(const vector<MatrixXd>& slabs)
{
...
// vector entries, and sum them
//////////////////////////////////////////////////////////////////////
MATRIX TENSOR3::modeThreeProduct(const VectorXd& x)
{
  assert(_slabs == x.size());
  assert(_slabs > 0);
...
//////////////////////////////////////////////////////////////////////
TENSOR3 TENSOR3::flipSlabsAndColumns() const
{
...
//////////////////////////////////////////////////////////////////////
TENSOR3 TENSOR3::flipSlabsAndRows() const
{
...
//////////////////////////////////////////////////////////////////////
// take the product w.r.t. mode three --
// this is really inefficient, and only present for verification
//////////////////////////////////////////////////////////////////////
TENSOR3 TENSOR3::modeThreeProduct(const MATRIX& m) const
{
  TENSOR3 flipped = this->flipSlabsAndColumns();
  TENSOR3 final = flipped.modeOneProduct(m);

  return final.flipSlabsAndColumns();
}
...
//////////////////////////////////////////////////////////////////////
void TENSOR3::write(FILE* file) const
{
...
// write to a file stream
//////////////////////////////////////////////////////////////////////
void TENSOR3::writeGz(gzFile& file) const
{
  ...
  for (int x = 0; x < _slabs; x++)
    _tensor[x].writeGz(file);
}

///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void TENSOR3::write(const string& filename) const
{
  FILE* file;
  ...
  if (file == NULL)
  {
    ...
    cout << " TENSOR3 write failed! " << endl;
...
// read from a file stream
//////////////////////////////////////////////////////////////////////
void TENSOR3::readGz(gzFile& file)
{
  ...
  for (int x = 0; x < _slabs; x++)
    _tensor[x].readGz(file);
}

//////////////////////////////////////////////////////////////////////
// read tensor from a file
//////////////////////////////////////////////////////////////////////
bool TENSOR3::readGz(const string& filename)
{
...
//////////////////////////////////////////////////////////////////////
// write the gzipped tensor to a file
//////////////////////////////////////////////////////////////////////
void TENSOR3::writeGz(const string& filename) const
{
  string copy = filename;
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
bool TENSOR3::read(const string& filename)
{
  int size = filename.size();
  if (filename[size - 1] == 'z' && filename[size - 2] == 'g')
  {
    return readGz(filename);
  }
