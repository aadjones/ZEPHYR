...
public:
  ...
  //TENSOR3(const vector<MatrixXd>& slabs);
  ...
  TENSOR3 flipSlabsAndColumns() const;

  // flip the slabs and rows of the tensor
  TENSOR3 flipSlabsAndRows() const;
  ...
  TENSOR3 modeThreeProduct(const MATRIX& m) const;
  ...
  MATRIX modeThreeProduct(const VectorXd& x);
