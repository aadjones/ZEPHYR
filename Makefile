...
BINS = fluidStam3D cubatureGeneratorStamStaged reducedStagedStam3D svdOutOfCoreMultiple buildProducts compressMatrices reducedCompressedStagedStam3D fluidIOP3D reducedIOP3D reducedCompressedIOP3D
